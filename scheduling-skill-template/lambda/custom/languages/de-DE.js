module.exports = {
  translation: {
    ...
    GREETING_REPROMPT: [
      ...
      'Ich kann einen Termin für dich planen. Möchtest du jetzt anfangen?',
    ],
    SCHEDULE_YES: [
    ...
    APPOINTMENT_CONFIRM_REPROMPT: [
      'Soll ich deine Terminanfrage für %s senden?',
    ],
    APPOINTMENT_CONFIRM_COMPLETED: [
      'Dein Termin mit %s am %s wurde geplant. Du wirst auch eine Email-Bestätigung erhalten. Bitte antwortet auf die Email-Bestätigung um abzusagen oder zu verschieben. Vielen Dank.',
    ],
    TIME_AVAILABLE: [
      '%s ist verfügbar. Möchtest du jetzt buchen?',
    ],
    TIME_AVAILABLE_REPROMPT: [
      'Möchtest du %s buchen?',
    ],
    TIME_NOT_AVAILABLE: [
      'Entschuldige, %s ist nicht verfügbar. Möchtest du eine andere Uhrzeit versuchen?',
    ],
    TIME_NOT_AVAILABLE_REPROMPT: [
      'Möchtest du eine andere Uhrzeit versuchen?',
    ],
    APPOINTMENT_TITLE: 'Termin mit %s.',
    APPOINTMENT_DESCRIPTION: 'Dies ist ein telefonischer Termin für %s mit %s. Wir werden dich um %s anrufen. Wenn du diesen Termin absagen oder ändern musst, antwortet bitte auf diese Email.',
    EMAIL_SUBJECT: 'Termin für %s mit %s.',
    EMAIL_TEXT: 'Dies ist ein telefonischer Termin für %s mit %s. Wir werden dich um %s anrufen. Wenn du diesen Termin absagen oder ändern musst, antwortet bitte auf diese Email.',
    ...
    PERMISSIONS_REQUIRED: 'Um Termine zu buchen oder zu bestätigen, benötigt %s Zugriff auf deinen Namen, deine Email-Adresse und deine Telefonnummer. Um den Zugriff zu erlauben, aktiviere bitte die Profil-Berechtigungen in der Amazon Alexa App.',
    ...
    FREEBUSY_DISABLED: 'Entschuldige, die Verfügbarkeitsprüfung ist deaktiviert. Möchten du trotzdem einen Termin vereinbaren?',
  },
};
