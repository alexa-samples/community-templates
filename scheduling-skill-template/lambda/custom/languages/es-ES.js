module.exports = {
  translation: {
    ...
    GREETING_REPROMPT: [
      ...
      'Puedo programar una cita para ti. ¿Te gustaría comenzar?',
    ],
    SCHEDULE_YES: [
      'Bien, programemos una cita.',
      'Bien, comencemos.',
      'Muy bien, vamos a programarte.',
    ],
    SCHEDULE_NO: [
      'Bien. Deténgate cuando quieres programar una cita.',
      'Bien, estaré aquí cuando quieres programar una cita.',
      'Muy bien, cuando estes listo para programar una cita, deténgate',
    ],
    HELP: [
      'Este skill puede ayudarte a programar una cita. ¿Te gustaría programar una cita?',
    ],
    HELP_REPROMPT: [
      '¿Te gustaría programar una cita?',
    ],
    ...
    NAME_REQUIRED_REPROMPT: 'Establezca su nombre en la aplicación Alexa.',
    PHONE_REQUIRED: 'Parece que no tienes configurado tu número de teléfono móvil. Puedes configurar tu número de móvil en la aplicación.',
    PHONE_REQUIRED_REPROMPT: 'Configura tu número de teléfono en la aplicación Alexa.',
    ERROR: 'Lo siento, no entendí eso. ¿Podrías repetirlo de nuevo?',
    ERROR_REPROMPT: '¿Podrías repetirlo de nuevo?',
    FREEBUSY_DISABLED: 'Lo sentimos, la verificación de disponibilidad está deshabilitada. ¿Deseas programar una cita de todos modos?',
  },
};
